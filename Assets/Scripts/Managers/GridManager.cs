...
public class GridManager : MonoBehaviour {
    ...
    private void Awake () {
        ...
        Instance = this;
        LeftDownTF = this.gameObject.transform.Find ("LeftDownTF");
        RightUpTF = this.gameObject.transform.Find ("RightUpTF");
        Init ();
    }
    public void Init () {
        //初始化 宽、高、网格、A*算法
    ...
    public bool IsAWall (int x, int y) {
        ...
        if (hitInfo.collider != null && hitInfo.collider.GetComponent<TilemapCollider2D> () != null) {
//            Debug.Log ("wall:" + x + "," + y);
            return true;
        }
        return false;
